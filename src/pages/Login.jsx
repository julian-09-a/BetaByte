...
import { API_URL } from "../context/Expor";
...
function Login() {
  ...
  const [loginCredenciales, setLoginCredenciales] = useState ({
    email: ' ',
    password: ' ',
  ...
  const handleChange = (event) =>{
    ...
    setLoginCredenciales(prevState => ({
      ...prevState,
      [name]: value
    }))
  }
  ...
  const handleSubmit = (event) => {
    ...
    const options = {
      ...
      body: JSON.stringify(loginCredenciales)
    }
    fetch(url, options)
